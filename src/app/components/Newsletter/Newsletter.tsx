            ...
            <S.SectionNewsLetter>
                <div className="content">
                    <div>
                        ...
                        <div className="text">
                            <p>Receba as últimas notícias, atualizações e outras coisas da semana.</p>
                        </div>
                        <S.WrapperButton>
                ...
                <div className="imgDiv"><S.ImgStyled src={imgNewsLetter}  alt="Caixa de correio" width={332} height={332}/></div>
            </S.SectionNewsLetter>
        </S.NewsLetterContainer>
